...
getContractFactory(name: 'ShadowVault', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.ShadowVault__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'ShadowVault', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.ShadowVault>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'ShadowVault', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.ShadowVault>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'ShadowVault', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.ShadowVault>
